...
<!-- /#left -->
                <div id="content">
                    <div class="outer">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="adsoy" placeholder="Kullanıcı Adı" id="username" class="form-control">
                            </div>
                        </div>
                        <br><br>
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="password" name="sifre" placeholder="Kullanıcı sifresi" id="pass" class="form-control">
                            </div>
                        </div>
                        <br><br>
						<div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="tel" placeholder="Telefon" id="pass" class="form-control">
                            </div>
                        </div>
						<br><br>
						<div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="adres" placeholder="Adres" id="pass" class="form-control">
                            </div>
                        </div>
						<br><br>
						<div class="form-group">
    ...
    <option>Zonguldak</option>
                      ...
                      <a  href="#" class="btn btn-default btn-grad" data-original-title="" title="">ÇIKIŞ</a>
                     	</div>
