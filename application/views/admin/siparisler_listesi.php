...
<div class="col-lg-6 ui-sortable" style="width: auto">
        <div class="box ui-sortable-handle" style="position: relative">
            <header>
                <button type="button"  class="btn btn-info btn-xs btn-grad"><h5><a href="<?=base_url()?>admin/siparis/ekle">
                ...
                <table class="table table-striped responsive-table">
                    <thead>
						...
						<tr>
							...
							<td><a href="<?=base_url()?>admin/siparisler/siparisdetay/<?=$rs->Id?>"class="btn btn-block bbtn-success btn-xs">
							<i class="glyphicon glyphicon-search"></i>Detay</a></td>
							</tr>
						<?php
						}
						?>
